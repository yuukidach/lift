...
pub enum WindowCommand {
    ...
    ToggleFocusLayer { window: Option<WindowId> },
    ToggleFloating { window: Option<WindowId> },
    ToggleFullscreen {
        window: Option<WindowId>,
        within_gaps: bool,
    },
    ...
    Unjoin { window: Option<WindowId> },
    ToggleOrientation { window: Option<WindowId> },
    Swap { first: WindowId, second: WindowId },
    Close(Option<WindowId>),
    Next { window: Option<WindowId> },
    Previous { window: Option<WindowId> },
}
