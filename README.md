...
- Hot-reloaded application rules, a native menu bar indicator with active-workspace highlighting and primary App icons, optional Mission Control UI, Stack Line, and grouped-window indicators.
